						...
						<div class="row">
							<div class="col-xs-12">
								<section class="panel">
                                    ...
                                    <?php
	$tempid=$_REQUEST["eid"];
	echo $result=mysql_query("select image from clientimg where cid=$tempid") or die("error");
	if(isset($result))
	{
...
if(isset($_REQUEST['SAVE'])) 
{
	...
	$ColumName= array('cname','discription','image');
	$ColumValue= array($_REQUEST['pname'],$_REQUEST['discription'],$image_name);
	$objDB->Update('clientimg','cid',$_REQUEST['pid'],$ColumName,$ColumValue);
	$objDB->close();
	print "<META http-equiv='refresh' content='0;URL=view_clients.php'>";	
	exit;
}
?>
<?php
		...
		$tempid=$_REQUEST["eid"];
		$result=mysql_query("select * from clientimg where cid=$tempid") or die("error");
		if(isset($result))
		{
			$tmp_val = mysql_fetch_row($result);
	  ?>
                                            ...
                                            <div class="col-md-7">
								            <input name="discription" type="text" class="form-control input-lg" value="<?php  echo $tmp_val[2];  ?>"/>
                                            </div>
							                </div>
							...
							<div class="form-group">
												<label class="col-md-2 control-label">Image</label>
												<div class="col-md-7">
												<img src="../images/<?php echo $tmp_val['3']; }?>" width="400" height="150" alt="No Image" />
												</div>
											</div>
