						...
						<div class="row">
							<div class="col-xs-12">
								<section class="panel">
									<?php
									$ids=$_REQUEST['id'];
									$data=mysql_query("select * from `track` where id='$ids'");
									$fetch=mysql_fetch_assoc($data);
									$ide=$fetch['id'];
									$awb=$fetch['awb'];
									$consignee=$fetch['consignee'];
									$bookdate=$fetch['bookdate'];
									$country=$fetch['country'];
									$status=$fetch['status'];
									$ddate=$fetch['ddate'];
									$rcvrname=$fetch['rcvrname'];
									$web=$fetch['web'];
									$forwn=$fetch['forwn'];
								?>
									<form action="track_edit_process.php?id=<?php echo $ide;?>" class="form-horizontal" method="post" enctype="multipart/form-data">
									
									<div class="control-group">
										<label class="control-label">AWB No</label>
										<div class="controls">
											<input type="text" class="span6 m-wrap" name="awb"  value="<?php echo $awb;?>"  />
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">consignee</label>
											<div class="controls">
												<input type="text" class="span6 m-wrap" name="consignee" value="<?php echo $consignee;?>"/>
											</div>
									</div>
									<div class="control-group">
										<label class="control-label">Book Date</label>
											<div class="controls">
												<input type="date" class="span6 m-wrap" name="bookdate" value="<?php echo $bookdate;?>"/>
											</div>
									</div>
									<div class="control-group">
										<label class="control-label">Country</label>
											<div class="controls">
												<input type="text" class="span6 m-wrap" name="country" value="<?php echo $country;?>" />
											</div>
									</div>
									<div class="control-group">
										<label class="control-label">Status</label>
											<div class="controls">
												<input type="text" class="span6 m-wrap" name="status" value="<?php echo $status;?>" />
											</div>
									</div>	
									<div class="control-group">
										...
										<div class="controls">
											<input type="date" class="span6 m-wrap" name="ddate" value="<?php echo $ddate;?>" />
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">Receiver Name</label>
											<div class="controls">
												<input type="text" class="span6 m-wrap" name="rcvrname" value="<?php echo $rcvrname;?>" />
											</div>
									</div>
									<div class="control-group">
										<label class="control-label">Website</label>
											<div class="controls">
												<input type="text" class="span6 m-wrap" name="web" value="<?php echo $web;?>" />
											</div>
									</div>
									<div class="control-group">
										<label class="control-label">forwarding No</label>
											<div class="controls">
												<input type="text" class="span6 m-wrap" name="forwn" value="<?php echo $forwn;?>" />
											</div>
									</div>
									...
									<!---<div class="control-group">
										...
										<div class="controls">
											<textarea class="span12 ckeditor m-wrap" name="description" rows="6">
