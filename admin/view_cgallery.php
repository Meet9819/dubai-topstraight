...
include("include/database.class.php");
		...
		while($data=mysql_fetch_assoc($result))
		{
			...
			echo    '<td>'.$data['cimg'].'</td>';
			
			
			echo    '<td>';
			echo    '<div class="col-sm-6 text-right">';
			echo	'<a href="edit_cgallery.php?eid='.$xid.'"><button type="update" class="btn btn-primary hidden-xs">Update</button></a>';
			echo	'</div>';
            echo    '<div class="col-sm-2 text-right">';
			echo    '<a href="delete_cgallery.php?eid='.$xid.'"><button type="delete" class="btn btn-primary hidden-xs">Delete</button></a>';
			echo	'</div>';
			echo	'</td>';
		    echo  	'</tr>';
			$tmpid++;
		...
		$link="view_cgallery.php"; // Page name
